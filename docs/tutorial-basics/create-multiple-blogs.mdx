...
### 1\. Create your additional blog folders {/* #1-create-your-additional-blog-folders */}
...
### 2. Configure `docusaurus.config.js` {/* #2-configure-docusaurusconfigjs */}
...
### 3\. Add Blog Posts {/* #3-add-blog-posts */}
...
### 4\. Link in your Navbar {/* #4-link-in-your-navbar */}
...
### How to use this `authors.yml` in Docusaurus: {/* #how-to-use-this-authorsyml-in-docusaurus */}
