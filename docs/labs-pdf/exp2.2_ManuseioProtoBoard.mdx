...
<div style={{ textAlign: "center" }}>
  ![OCR图片](/img/imported/bdb36261dc4e26eafedc8bb0d1099bbb2bef584d.png)
</div>
...
Quando em operação o LED apresenta uma queda de tensão $ (V\_{\gamma}) $ ,da ordem de 1,7 a 2,1V entre seus terminais e deve passar por ele uma corrente de aproximadamente 10mA a fim de que este possa emitir uma luminosidade ideal.

<div style={{ textAlign: "center" }}>
  ![OCR图片](/img/imported/857e1d2f360d513b617be35d731b231cfc0fea7e.png)
</div>
...
<div style={{ textAlign: "center" }}>
  ![OCR图片](/img/imported/9e17573dff5b97ebc14097f1f5578afcd3265279.png)
</div>
...
<div style={{ textAlign: "center" }}>
  ![OCR图片](/img/imported/af3fcd9c1d5e16193e1b1f0302764f27b2a4dee0.png)
</div>
...
<div style={{ textAlign: "center" }}>
  ![OCR图片](/img/imported/cee377a7e8ddd24d2a789d033b8a3022aa234e50.png)
</div>
...
<div style={{ textAlign: "center" }}>
  ![OCR图片](/img/imported/68c706e3330e28d4f0eb56fa68ad349b80132aea.png)
</div>
...
<div style={{ textAlign: "center" }}>
  ![OCR图片](/img/imported/419acd580b04914d4a7c72fcff32665c6d4af6fb.png)
</div>
...
<div style={{ textAlign: "center" }}>
  ![OCR图片](/img/imported/f090ebf629fe43553abc2c0ef12cc0b0434fc320.png)
</div>
...
Para praticar o uso da matriz de contatos foi construído um circuito oscilador com frequência em tomo de 1 Hz. Na prática, o oscilador apresentou a frequência de***Hz. Para determinar a frequência do oscilador foi utilizado o seguinte procedimento: ***
